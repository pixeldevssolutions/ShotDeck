...
is no API for a menu of its own -- so the ShotDeck actions go under File,
...
def confirm(text):
    ...
    answer = QtWidgets.QMessageBox.question(
        _painter().ui.get_main_window(), "ShotDeck", text,
...
def ask_path(start_dir, extension, suggested=""):
    ...
    path, _filter = QtWidgets.QFileDialog.getSaveFileName(
        _painter().ui.get_main_window(), "ShotDeck: Save As", start,
